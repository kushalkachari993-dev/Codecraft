...
test("Data Engineering contains three distinct, complete 21-topic paths", () => {
  assert.deepEqual(Object.keys(DATA_CURRICULA), PACES); assert.equal(DATA_PATH_TOTAL, 21); assert.equal(DATA_TRACK.total, 63);
