...
export type JourneyTrackId = "python" | "genai" | "sql" | "cloud" | "backend" | "frontend" | "data" | "security";
...
export function loadJourneyPreferences(): JourneyPreferences {
  try {
    ...
    const trackId = parsed.trackId === "genai" || parsed.trackId === "sql" || parsed.trackId === "cloud" || parsed.trackId === "backend" || parsed.trackId === "frontend" || parsed.trackId === "data" || parsed.trackId === "security" ? parsed.trackId : "python";
