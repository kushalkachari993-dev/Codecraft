...
export type JourneyTrackId = "python" | "genai" | "sql" | "cloud" | "backend";
...
export function loadJourneyPreferences(): JourneyPreferences {
  try {
    ...
    const trackId = parsed.trackId === "genai" || parsed.trackId === "sql" || parsed.trackId === "cloud" || parsed.trackId === "backend" ? parsed.trackId : "python";
