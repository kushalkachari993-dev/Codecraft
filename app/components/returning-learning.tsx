...
async function loadPath(visit: LessonVisit): Promise<PathSummary> {
  ...
  if (visit.trackId === "security") {
    const { getSecurityLessons } = await import("../security/curriculum");
    return { lessons: getSecurityLessons(visit.paceId), projects: [] };
  }
...
const labels = { python: "Python", genai: "GenAI", sql: "SQL", cloud: "Cloud Engineering", backend: "Backend Engineering", frontend: "Frontend Web Development", data: "Data Engineering", security: "Cybersecurity Engineering" };
