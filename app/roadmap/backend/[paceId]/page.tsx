...
export default async function BackendRoadmapPage({ params }: { params: Promise<{ paceId: string }> }) {
  const { paceId } = await params;
  return <BackendApp paceId={isBackendPaceId(paceId) ? paceId : "beginner"} roadmap />;
}
