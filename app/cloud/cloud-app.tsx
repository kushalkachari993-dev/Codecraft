    ...
    <main className="app-shell track-python cloud-app">
      ...
      {effectiveLessonId !== undefined ? (
        <section className="lesson-page" id="cloud-content">
          ...
          {!lesson ? <div className="cloud-gate"><h1>Lesson not found</h1><a href="/tracks/cloud">Explore Cloud Engineering paths →</a></div> : !ready ? <p className="view-loading" role="status">Loading your local learning progress…</p> : !unlocked ? (
            <section className="cloud-gate"><h1>This lesson is locked</h1><p>Complete lesson {nextId}, including its simulation, to continue in order.</p><a className="curriculum-next cloud-button" href={cloudLessonPath(paceId, nextId)}>Continue lesson {nextId} →</a></section>
